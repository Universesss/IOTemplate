...
public:
    ...
    Drive(enum ::drive_setup drive_setup, motor_group DriveL, motor_group DriveR, int gyro_port, float wheel_diameter, float wheel_ratio, float gyro_scale);
    ...
    // Default Swing
    void Sverve(float leftSpeed, float rightSpeed, float duration);
    void Sverve(float leftSpeed, float rightSpeed, bool leftDirection, bool rightDirection, float duration);

    // Pivot Swing
    // void Sverve(double radius, double angle, double speed);
